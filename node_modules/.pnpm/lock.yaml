...
importers:
  ...
  .:
    dependencies:
      ...
      inquirer:
        specifier: ^12.0.0
        version: 12.0.0(@types/node@22.7.7)
...
packages:
  ...
  '@inquirer/editor@4.0.0':
    resolution: {integrity: sha512-bhHAP7hIOxUjiTZrpjyAYD+2RFRa+PNutWeW7JdDPcWWG3GVRiFsu3pBGw9kN2PktoiilDWFGSR0dwXBzGQang==}
    engines: {node: '>=18'}
  ...
  '@inquirer/number@3.0.0':
    resolution: {integrity: sha512-DUYfROyQNWm3q+JXL3S6s1/y/cOWRstnmt5zDXhdYNJ5N8TgCnHcDXKwW/dRZL7eBZupmDVHxdKCWZDUYUqmeg==}
    engines: {node: '>=18'}

  '@inquirer/password@4.0.0':
    resolution: {integrity: sha512-W4QRSzJDMKIvWSvQWOIhs6qba1MJ6yIoy+sazSFhl2QIwn58B0Yw3iZ/zLk3QqVcCsTmKcyrSNVWUJ5RVDLStw==}
    engines: {node: '>=18'}

  '@inquirer/prompts@7.0.0':
    resolution: {integrity: sha512-y8kX/TmyBqV0H1i3cWbhiTljcuBtgVgyVXAVub3ba1j5/G+dxhYohK1JLRkaosPGKKf3LnEJsYK+GPabpfnaHw==}
    engines: {node: '>=18'}

  '@inquirer/rawlist@4.0.0':
    resolution: {integrity: sha512-frzJNoMsQBO1fxLXrtpxt2c8hUy/ASEmBpIOEnXY2CjylPnLsVyxrEq7hcOIqVJKHn1tIPfplfiSPowOTrrUDg==}
    engines: {node: '>=18'}

  '@inquirer/search@3.0.0':
    resolution: {integrity: sha512-AT9vkC2KD/PLHZZXIW5Tn/FnJzEU3xEZMLxNo9OggKoreDEKfTOKVM1LkYbDg6UQUOOjntXd0SsrvoHfCzS8cw==}
    engines: {node: '>=18'}
...
snapshots:
  ...
  inquirer@12.0.0(@types/node@22.7.7):
    dependencies:
      '@inquirer/core': 10.0.0(@types/node@22.7.7)
      '@inquirer/prompts': 7.0.0(@types/node@22.7.7)
      '@inquirer/type': 3.0.0(@types/node@22.7.7)
